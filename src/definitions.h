...
static constexpr auto MINOR_VERSION = "20";
static constexpr auto STATUS_SERVER_CREDITS = "TFS team";
static constexpr auto STATUS_SERVER_CONTRIBUTORS = "Mark Samman";
